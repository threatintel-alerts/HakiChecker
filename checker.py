...
hybrid_apikey = "84u8q1cn27dba97fljzlkjkc905f5bbayaswl430d515baf4ay2lbvo4a1be7c12"
...
def saveRecord(data, formula):
    if formula == "ip":
        ...
        with open(result_ip_name, mode="a+", encoding="utf-8", newline="") as csv_file:
            ...
            malic = "Safe"
            nonzero = 0
            if data[1].startswith("1 out") == False and data[1].startswith("N/A") == False:
                #malic = "Malicious"
                nonzero += 1
            if data[2].startswith("0 out") == False and data[2].startswith("N/A") == False:
                #malic = "Malicious"
                nonzero += 1
            if data[3].startswith("1 out") == False and data[3].startswith("N/A") == False:
                #malic = "Malicious"
                nonzero += 1
            if int(data[4]) != 0:
                #malic = "Malicious"
        ...
        with open(result_url_name, mode="a+", encoding="utf-8", newline="") as csv_file:
            ...
            if data[2].startswith("0 out") == False and data[2].startswith("N/A") == False:
                #malic = "Malicious"
                nonzero += 1
            if data[3].startswith("0 out") == False and data[3].startswith("N/A") == False:
                #malic = "Malicious"
                nonzero += 1
            if data[4].startswith("Safe") == False and data[4].startswith("N/A") == False:
                #malic = "Malicious"
                nonzero += 1
            if nonzero > 0:
                malic = "To Block"
